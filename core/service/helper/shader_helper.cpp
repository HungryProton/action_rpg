...
namespace game{
	...
	GLuint ShaderHelper::GetShader(std::string vertex_filePath, std::string fragment_filePath){
	...
	GLuint ShaderHelper::LoadShaders(const char* vertex_filePath, const char* fragment_filePath){
